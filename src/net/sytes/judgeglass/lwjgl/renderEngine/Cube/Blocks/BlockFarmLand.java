...
public class BlockFarmLand {
	public static final Vector2[] UV_LEFT = {
			...
			new Vector2(0.1875f, 0.f), new Vector2(0.1875f, 0.0625f), new Vector2(0.25f, 0.0625f), new Vector2(0.25f, 0.0625f),
			new Vector2(0.25f, 0.f), new Vector2(0.1875f, 0.f)
	...
	public static final Vector2[] UV_TOP = {
			...
			new Vector2(6f/16f, 7f/16f), new Vector2(6f/16f, 8f/16f), new Vector2(7f/16f, 8f/16f), new Vector2(7f/16f, 8f/16f),
			new Vector2(7f/16f, 7f/16f), new Vector2(6f/16f, 7f/16f)
