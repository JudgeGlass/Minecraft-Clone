...
public class BlockSand {
	public static final Vector2[] UV_LEFT = {
			...
			new Vector2(0.875f, 0.f), new Vector2(0.875f, 0.0625f), new Vector2(0.9375f, 0.0625f), new Vector2(0.9375f, 0.0625f),
			new Vector2(0.9375f, 0.f), new Vector2(0.875f, 0.f)
