...
public class BlockRedFlower {
	...
	public static final Vector2[] UV_FRONT = {
			...
			new Vector2(13f/16f, 3f/16f), new Vector2(13f/16f, 4f/16f), new Vector2(14f/16f, 4f/16f), new Vector2(14f/16f, 4f/16f),
			new Vector2(14f/16f, 3f/16f), new Vector2(13f/16f, 3f/16f)
